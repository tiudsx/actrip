<style>
.fixed_wrap2{width:100%;padding-left:5px;height:40px;}
.cnb3 li{list-style:none;float:left;font-size:12px;padding-right:5px;}
...
.cnb3.center li{float:none;display:inline-block;}
</style>

<!--div class="fixed_wrap2">
	<ul class="cnb3 clear">
		<li><a href="/Campinfo">글램핑소개</a></li>
		<li><a href="/campres">예약하기</a></li>
		<li><a href="/camporder">예약조회</a></li>
		<li><a href="/qna" target="_blank">문의하기</a></li>
	</ul>
</div-->