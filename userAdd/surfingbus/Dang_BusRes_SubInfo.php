<div class="bd_tl inner" style="width:100%;">
	...
	<div class="max600">
	<form id="frmRes" action="<?=$folderUrl?>/Dang_BusRes_Save.php" method="post" style="display:;" target="ifrmResize" autocomplete="off">
		<span class="spanresinfo_temp">
				...
				<table class="et_vars exForm bd_tb " style="width:100%;margin-bottom:5px;">
					<tbody>
						...
						<tr>
							<th>특이사항</th>
							<td>
								<textarea name="etc" id="etc" rows="8" cols="42" style="margin: 0px; width: 97%; height: 100px;resize:none;">당찬패키지</textarea>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div style="padding:10px;display:; text-align:center;" id="divBtnRes">
				<div>
					<input type="button" class="gg_btn gg_btn_grid large gg_btn_color" style="width:200px; height:44px;" value="셔틀버스 예약" onclick="fnBusSaveDang();" />
				</div>
			</div>
		</span>
	</form>
