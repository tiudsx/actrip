			...
			<div class="bd max500 well" style="padding-top:7px;background-color: #f5f5f5;">
				...
				<table class="et_vars exForm bd_tb " style="width:100%;margin-bottom:8px;">
					<tbody>
						...
						<!--tr>
							<td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="5호차" onclick="fnBusPoint('Y', 5, this, '여의도');"></td>
							<td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="6호차" onclick="fnBusPoint('Y', 6, this, '당산역');"></td>
							<td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="7호차" onclick="fnBusPoint('Y', 7, this, '목동역');"></td>
							<td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="8호차" onclick="fnBusPoint('Y', 8, this, '시청역');"></td>
						</tr-->
					</tbody>
				</table>
				...
				<table class="et_vars exForm bd_tb " style="width:100%;margin-bottom:8px;">
					<tbody>
						<tr>
							<td style="width:25%;text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="1호차" onclick="fnBusPoint('S', 1, this, '주문진해변');"></td>
			...
			<div class="bd" style="padding:0px;">
				<table view="tbBusS" class="et_vars exForm bd_tb " style="width:100%;margin-bottom:8px;display:none;">
					...
					<tbody>
						<tr>
							<td colspan="3" height="28"><b>[서울행] <span id="pointnumS01"></span>호차 셔틀버스</b></td>
						</tr>
						<tr>
							<th style="text-align:center;"><span id="pointnumS1"></span>호차 정류장</th>
							<th style="text-align:center;">탑승장소 및 시간</th>
							<th style="text-align:center;">위치</th>
						</tr>
						<tr>
							<th>주문진해변</th>
							<td>청시행비치 주차장 입구<br><font color="red">14시 15분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 1, 1, '주문진해변');"></td>
						</tr>
						<tr>
							<th>남애해변</th>
							<td>남애3리 입구<br><font color="red">14시 30분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 2, 1, '남애해변');"></td>
						</tr>
						<tr>
							<th>인구해변</th>
							<td>현남보건지소 맞은편<br><font color="red">14시 35분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 3, 1, '인구해변');"></td>
						</tr>
						<tr>
							<th>죽도해변</th>
						...
						<tr>
							<th>동산항해변</th>
							<td>동산항해변 입구<br><font color="red">14시 45분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 5, 1, '동산항해변');"></td>
						</tr>
						<tr>
							<th>기사문해변</th>
							<td>기사문 해변주차장 입구<br><font color="red">14시 50분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 6, 1, '기사문해변');"></td>
						</tr>
						<tr>
							<th>하조대해변</th>
							<td>서피비치 회전교차로 횡단보도 앞<br><font color="red">15시 00분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 7, 1, '하조대해변');"></td>
						</tr>
						<!--tr>
							<th>동호해변</th>
							<td>동호해변 버스정류장<br><font color="red">15시 05분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 6, 1, '동호해변');"></td>
						</tr>
						<tr>
							<th>설악해변</th>
							<td>설악해변 주차장입구<br><font color="red">15시 15분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 7, 1, '설악해변');"></td>
						</tr-->
						<tr>
				...
				<table view="tbBusS" class="et_vars exForm bd_tb " style="width:100%;margin-bottom:8px;display:none;">
					...
					<tbody>
						<tr>
							<td colspan="3" height="28"><b>[서울행] <span id="pointnumS02"></span>호차 셔틀버스</b></td>
						</tr>
						<tr>
							<th style="text-align:center;"><span id="pointnumS2"></span>호차 정류장</th>
							<th style="text-align:center;">탑승장소 및 시간</th>
							<th style="text-align:center;">위치</th>
						</tr>
						<tr>
							<th>주문진해변</th>
							<td>청시행비치 주차장 입구<br><font color="red">17시 15분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 1, 1, '주문진해변2');"></td>
						</tr>
						<tr>
							<th>남애해변</th>
							<td>남애남애3리 입구<br><font color="red">17시 30분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 2, 1, '남애해변2');"></td>
						</tr>
						<tr>
							<th>인구해변</th>
							<td>현남보건지소 맞은편<br><font color="red">17시 35분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 3, 1, '인구해변2');"></td>
						</tr>
						<tr>
							<th>죽도해변</th>
						...
						<tr>
							<th>동산항해변</th>
							<td>동산항해변 입구<br><font color="red">17시 45분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 5, 1, '동산항해변2');"></td>
						</tr>
						<tr>
							<th>기사문해변</th>
							<td>기사문 해변주차장 입구<br><font color="red">17시 50분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 6, 1, '기사문해변2');"></td>
						</tr>
						<tr>
							<th>하조대해변</th>
							<td>서피비치 회전교차로 횡단보도 앞<br><font color="red">18시 00분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 7, 1, '하조대해변2');"></td>
						</tr>
						<!--tr>
							<th>동호해변</th>
							<td>동호해변 버스정류장<br><font color="red">18시 05분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 6, 1, '동호해변2');"></td>
						</tr>
						<tr>
							<th>설악해변</th>
							<td>설악해변 주차장입구<br><font color="red">18시 15분</font></td>
							<td><input type="button" class="bd_btn " style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 7, 1, '설악해변2');"></td>
						</tr-->
						<tr>
