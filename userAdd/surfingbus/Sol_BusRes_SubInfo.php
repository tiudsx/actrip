<div class="bd_tl inner" style="width:100%;">
	...
	<div class="max600">
	<form id="frmRes" action="<?=$folderUrl?>/Sol_BusRes_Save.php" method="post" style="display:;" target="ifrmResize" autocomplete="off">
		<span class="spanresinfo_temp">
			...
			<div style="padding:10px;display:; text-align:center;" id="divBtnRes">
				<div>
					<input type="button" class="gg_btn gg_btn_grid large gg_btn_color" style="width:200px; height:44px;" value="셔틀버스 예약" onclick="fnBusSaveSol();" />
				</div>
			</div>
		</span>
	</form>
