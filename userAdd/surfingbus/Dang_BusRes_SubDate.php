					...
					<tr>
						...
						<td>
							<select id="busStop" name="busStop" class="select" onchange="fnBusChange(this.value);">
								...
								<option value="A" selected>왕복 : 서울 <-> 양양</option>
							</select>
						</td>
					</tr>
					<tr id="trY">
						<th>양양행</th>
						<td>
							<input type="text" id="SurfBusY" name="SurfBusY" readonly="readonly" value="2019-06-22" class="itx2" cal="sbusdate_dang" maxlength="7">
						</td>
					</tr>
					<tr id="trS" style="display:;">
						<th>서울행</th>
						<td>
							<input type="text" id="SurfBusS" name="SurfBusS" readonly="readonly" value="2019-06-22" class="itx2" cal="ebusdate_dang" maxlength="7">
						</td>
					</tr>
				<tbody>
			</table>
			...
			<table class="et_vars exForm bd_tb">
				...
				<tbody>
					...
					<tr id="busY1" trId="BusY">
						...
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 1);"></td>
					</tr>
					<tr id="busY2" trId="BusY">
						<th style="text-align:center;">2호차</th>
						<td>당산역 &gt; 합정역 &gt; 신촌역 &gt; 충정로역 &gt; 종로3가역 &gt; 왕십리역 &gt; 건대입구역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 2);"></td>
					</tr>
					<tr id="busY3" trId="BusY">
						<th style="text-align:center;">3호차</th>
						<td>목동역 &gt; 영등포역 &gt; 흑석역 &gt; 신반포역 &gt; 논현역 &gt; 강남구청역 &gt; 종합운동장역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 3);"></td>
					</tr>
					<tr id="busY4" trId="BusY">
						<th style="text-align:center;">4호차</th>
						<td>시청역 &gt; 신용산 &gt; 사당역 &gt; 강남역 &gt; 종합운동장역 &gt; 잠실역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 4);"></td>
					</tr>
					<tr id="busY5" trId="BusY">
						<th style="text-align:center;">5호차</th>
						<td>여의도 &gt; 신도림 &gt; 구로디지털단지 &gt; 봉천역 &gt; 사당역 &gt; 강남역 &gt; 종합운동장역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 5);"></td>
					</tr>
					<tr id="busY6" trId="BusY">
						<th style="text-align:center;">6호차</th>
						<td>당산역 &gt; 합정역 &gt; 신촌역 &gt; 충정로역 &gt; 종로3가역 &gt; 왕십리역 &gt; 건대입구역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 6);"></td>
					</tr>
					<tr id="busY7" trId="BusY">
						<th style="text-align:center;">7호차</th>
						<td>목동역 &gt; 영등포역 &gt; 흑석역 &gt; 신반포역 &gt; 논현역 &gt; 강남구청역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 7);"></td>
					</tr>
					<tr id="busY8" trId="BusY">
						<th style="text-align:center;">8호차</th>
						<td>시청역 &gt; 신용산 &gt; 사당역 &gt; 강남역 &gt; 종합운동장역 &gt; 잠실역</td>
						<td><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('Y', 8);"></td>
					</tr>
					<tr>
		...
		<div id="eBusArea1" style="display:none;">
			...
			<table class="et_vars exForm bd_tb" style="width:100%;" id="busS1" tbId="BusS">
				...
				<tbody>
					...
					<tr>
						<th style="text-align:center;">1호차<br>(오후 2:50)</th>
						<td>기사문 해변주차장 입구</td>
						<td style="text-align:center;"><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('S', 1);"></td>
					</tr>
					<tr>
			...
			<table class="et_vars exForm bd_tb" style="width:100%;margin-top:3px;" id="busS2" tbId="BusS">
				...
				<tbody>
					<tr>
						<th style="text-align:center;">2호차<br>(오후 5:50)</th>
						<td>기사문 해변주차장 입구</td>
						<td style="text-align:center;"><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('S', 2);"></td>
					</tr>
					<tr>
			...
			<table class="et_vars exForm bd_tb" style="width:100%;" id="busS3" tbId="BusS">
				...
				<tbody>
					<tr>
						<th style="text-align:center;">3호차<br><span>(오후 2:50)</span></th>
						<td>기사문 해변주차장 입구</td>
						<td style="text-align:center;"><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('S', 3);"></td>
					</tr>
					<tr>
						<td colspan="3">도착 : 잠실역 &gt; 종합운동장역 &gt; 강남역 &gt; 사당역 &gt; 신용산역 &gt; 시청역</td>
					</tr>
			...
			<table class="et_vars exForm bd_tb" style="width:100%;margin-top:4px;" id="busS4" tbId="BusS">
				...
				<tbody>
					<tr>
						<th style="text-align:center;">4호차<br>(오후 5:50)</th>
						<td>기사문 해변주차장 입구</td>
						<td style="text-align:center;"><input type="button" class="bd_btn " style="padding-top:4px;" value="선택" onclick="fnBusSeatDang('S', 4);"></td>
					</tr>
					<tr>
						<td colspan="3">도착 : 잠실역 &gt; 종합운동장역 &gt; 강남역 &gt; 사당역 &gt; 당산역 &gt; 합정역</td>
					</tr>
		...
		<div style="text-align:center;padding-top:10px;display:none;">
			<input type="button" class="gg_btn gg_btn_grid large gg_btn_color" style="width:50%; height:38px;" value="좌석선택하기" onclick="fnBusSeatViewDang();" />
		</div>