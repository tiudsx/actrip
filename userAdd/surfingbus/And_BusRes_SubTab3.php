			...
			<div class="bd max500 well" style="padding-top:7px;background-color: #f5f5f5;">
				...
				<table class="et_vars exForm bd_tb " style="width:100%;margin-bottom:8px;">
					<tbody>
						<tr>
							<td style="width:25%;text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="서울행" onclick="fnBusPointAnd('S', 1, this, '동산항해변');"></td>
