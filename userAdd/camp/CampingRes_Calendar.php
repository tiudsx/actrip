...
// 변수 $s 에 새로운 값을 넣고 새문서를 만들면, $s 가 들어와 원하는 값을 표시해 줍니다.
	...
	");
	if($selMonth > date("Ym", strtotime($nowMonth." -1 month"))){
	...
	$calDayList = array();
	$calDayList["201902"] = array("yearS" => "2019", "monthS" => "03", "dayS" => "15", "yearE" => "2019", "monthE" => "06", "dayE" => "30", "plusprice" => "0");
	$calDayList["201903"] = array("yearS" => "2019", "monthS" => "03", "dayS" => "15", "yearE" => "2019", "monthE" => "06", "dayE" => "30", "plusprice" => "0");
	$calDayList["201904"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "06", "dayE" => "30", "plusprice" => "0");
	$calDayList["201905"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "06", "dayE" => "30", "plusprice" => "0");
	$calDayList["201906"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "06", "dayE" => "30", "plusprice" => "0");
	$calDayList["201907"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "08", "dayE" => "31", "plusprice" => "10000");
	$calDayList["201908"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "08", "dayE" => "31", "plusprice" => "10000");
	$calDayList["201909"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "11", "dayE" => "30", "plusprice" => "0");
	$calDayList["201909"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "11", "dayE" => "30", "plusprice" => "0");
	$calDayList["201909"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "11", "dayE" => "30", "plusprice" => "0");
	$calDayList["201910"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "11", "dayE" => "30", "plusprice" => "0");
	$calDayList["201911"] = array("yearS" => "2019", "monthS" => "04", "dayS" => "01", "yearE" => "2019", "monthE" => "11", "dayE" => "30", "plusprice" => "0");

	$calDay = array();
	$price0 = $calDayList[$s_Y.$s_m]["plusprice"];

	$forI=1;
	$forE=$s_t;

	if($calDayList[$s_Y.$s_m]["yearS"] == $s_Y && $calDayList[$s_Y.$s_m]["monthS"] == $s_m){
		$forI = $calDayList[$s_Y.$s_m]["dayS"];
	}else if($calDayList[$s_Y.$s_m]["yearE"] == $s_Y && $calDayList[$s_Y.$s_m]["monthE"] == $s_m){
		$forE = $calDayList[$s_Y.$s_m]["dayE"];
	}

	//예약 가능한 날짜 배열
	if($calDayList[$s_Y.$s_m]){
		for($i=$forI;$i<=$forE;$i++){
			$calDay[$i] = array("price0" => $price0);
		}
	}
    ...
    for($r=0;$r<=$ra;$r++){
		...
		for($z=1;$z<=7;$z++){
			...
			if($ru<=0 || $ru>$s_t){ 
				...
				{
					if($s >= date("Y-m-d", strtotime($nowDate." -1 day")) && !($h >= 10 && $s == date("Y-m-d", strtotime($nowDate." -1 day")))){
						$pricePlus = "price0='".$price0."'";

						echo "<td class='cal_type2' style='cursor:pointer;padding-bottom:0px;'><calBox class='tour_td_block' value='$s' weekNum='$weeknum' onclick='fnPassenger(this, 1);' $pricePlus><span class='tour_cal_day' $holidayChk>$ru</span><span class='tour_cal_pay'>예약가능</span></calBox></td>";
					}else{
						echo "<td class='cal_type2' style='padding-bottom:2px;'><span class='tour_td_block'><span class='tour_cal_day' style='color:#c2c2c2;'>$ru</span><span class='tour_cal_pay' style='color:#d0d0d0;'></span></span></td>";
					}
				}
			}
		}
