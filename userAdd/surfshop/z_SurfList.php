...
$select_query = 'SELECT * FROM SURF_SHOP a INNER JOIN SURF_CODE b ON b.gubun = "'.$param.'" AND a.cate_3 = b.seq AND a.groupcode = "surf" where '.$areaSql.' intSeq IN (SELECT shopSeq FROM SURF_SHOP_AD WHERE gubun = "surflist" AND adUseYN = "Y") AND a.useYN = "Y" ORDER BY rand()';
...
?>
				<li class="recommend-item " tabindex="-1">
					<div class="item-inner">
						<div class="image-box">
							<a href="/zsurfres?seq=<?=$row["intseq"]?>"><img src="<?=$row['shop_listimg']?>" onerror="this.src='http://skinnz.godohosting.com/surfenjoy/shop/none_200x188.jpg'"></a>
							<div class="badge-rap">
						...
						<div class="info-box">
							<div class="title-rap">
								<a href="/zsurfres?seq=<?=$row["intseq"]?>">
									<div>
