...
/*
	if($groupcode == "surf"){
		$arrShopT[$code] = $shopname;
		$arrShopCateT[$gubun][$code] = $codename;
		...
		$shoplist2 .= "shopList2.etc.$shopcode = '$shopname';";
		$shopcate3 .= "shopList3.$shopcode = {};";

		$shoplist3 .= 'shopList3.'.$shopcode.'["'.$intseq.'"] = "'.$shopname.'";';
	}
*/
}
...
<div class="bd_tl" style="width:100%;display:;">
	<h1 class="ngeb clear"><i class="bg_color"></i>예약관리 - 전체</h1>
</div>
...
<div class="container" id="contenttop">
  <section>
    <article class="right_article3">
		<?include 'SuperAdmin_SurfCalendar.php'?>
    </article>
