...
var busPointListY1 = {
    "신도림"		: [0, MARKER_SPRITE_Y_OFFSET*3, '37.5095592', '126.8885712', '홈플러스 신도림점 앞', '탑승시간 : <font color="red">06시 00분 / 07시 00분</font>', 0],
    "대림역	": [MARKER_SPRITE_X_OFFSET*1, MARKER_SPRITE_Y_OFFSET*3, '37.4928008', '126.8947074', '대림역 2번출구 앞', '탑승시간 : <font color="red">06시 10분 / 07시 10분</font>', 1],
    "봉천역"		: [MARKER_SPRITE_X_OFFSET*2, MARKER_SPRITE_Y_OFFSET*3, '37.4821436', '126.9426997', '봉천역 1번출구 앞', '탑승시간 : <font color="red">06시 20분 / 07시 20분</font>', 2],
    "사당역"		: [MARKER_SPRITE_X_OFFSET*3, MARKER_SPRITE_Y_OFFSET*3, '37.4764763', '126.977734', '사당역 6번출구 방향 신한성약국 앞', '탑승시간 : <font color="red">06시 30분 / 07시 30분</font>', 3],
    "강남역"		: [MARKER_SPRITE_X_OFFSET*4, MARKER_SPRITE_Y_OFFSET*3, '37.4982078', '127.0290928', '강남역 1번출구 버스정류장', '탑승시간 : <font color="red">06시 45분 / 07시 45분</font>', 4],
    "종합운동장역"	: [MARKER_SPRITE_X_OFFSET*5, MARKER_SPRITE_Y_OFFSET*3, '37.5104765', '127.0722925', '종합운동장역 4번출구 방향 버스정류장', '탑승시간 : <font color="red">07시 00분 / 08시 00분</font>', 5]
};
var busPointListY2 = {
    "당산역"	: [0, MARKER_SPRITE_Y_OFFSET*3, '37.5344135', '126.9012162', '당산역 13출구 IBK기업은행 앞', '탑승시간 : <font color="red">06시 45분</font>', 0],
    ...
    "건대입구": [MARKER_SPRITE_X_OFFSET*4, MARKER_SPRITE_Y_OFFSET*3, '37.5393413', '127.0716672', '건대입구역 롯데백화점 스타시티점 입구', '탑승시간 : <font color="red">07시 45분</font>', 4],
...
var busPointListS1 = {
    ...
    "인구해변"	: [MARKER_SPRITE_X_OFFSET*2, 0, '37.968786', '128.761337', '현남보건지소 맞은편', '탑승시간 : <font color="red">14시 35분 / 17시 35분</font>', 2],
    "죽도해변"	: [MARKER_SPRITE_X_OFFSET*3, 0, '37.9720003', '128.7595433', 'GS25 죽도비치점 맞은편', '탑승시간 : <font color="red">14시 40분 / 17시 40분</font>', 3],
    "동산항해변"	: [MARKER_SPRITE_X_OFFSET*4, 0, '37.9763045', '128.7586692', '동산항해변 입구', '탑승시간 : <font color="red">14시 45분 / 17시 45분</font>', 4],
