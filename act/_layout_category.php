...
while ($row = mysqli_fetch_assoc($result_setlist)){
    ...
    if($reqCode == $row["code"]){
        $pointFirsthtml = "<li><a href='/surflist?code=".$row["code"]."'>".$row["codename"]." <i class='fas fa-caret-right'></i></a></li>";
    }else{

    }
    $pointhtml .= "<li><a href='/surflist?code=".$row["code"]."'>".$row["codename"]."</a></li>";
}
...
while ($row = mysqli_fetch_assoc($result_setlist)){
    $arealist .= "<li><a href='/surflist?code=".$row["code"]."'>".$row["areaname"]."</a></li>";
