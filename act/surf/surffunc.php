...
function fnBusPoint($vlu, $busNumber){	
	$busData = array(
		"Y1_신도림"=> "07:00|홈플러스 신도림점 앞"
		, "Y1_대림역"=> "07:10|대림역 2번출구 앞"
		, "Y1_봉천역"=> "07:20|봉천역 1번출구 앞"
		, "Y1_사당역"=> "07:30|사당역 6번출구 방향 신한성약국 앞"
		, "Y1_강남역"=> "07:45|강남역 1번출구 버스정류장"
		, "Y1_종합운동장역"=> "08:00|종합운동장역 4번출구 방향 버스정류장"
		, "Y2_당산역"=> "06:45|당산역 13출구 IBK기업은행 앞"
		, "Y2_합정역"=> "06:50|합정역 3번출구 앞"
		, "Y2_종로3가역"=> "07:15|종로3가역 12번출구 새마을금고 앞"
		, "Y2_왕십리역"=> "07:30|왕십리역 11번출구 우리은행 앞"
		, "Y2_건대입구"=> "07:45|건대입구역 롯데백화점 스타시티점 입구"
		, "Y2_종합운동장역"=> "08:00|종합운동장역 4번출구 방향 버스정류장"
		, "Y3_신도림"=> "06:00|홈플러스 신도림점 앞"
		, "Y3_대림역"=> "06:10|대림역 2번출구 앞"
		, "Y3_봉천역"=> "06:20|봉천역 1번출구 앞"
		, "Y3_사당역"=> "06:30|사당역 6번출구 방향 신한성약국 앞"
		, "Y3_강남역"=> "06:45|강남역 1번출구 버스정류장"
		, "Y3_종합운동장역"=> "07:00|종합운동장역 4번출구 방향 버스정류장"
		, "S1_청시행비치"=> "14:15|청시행비치 주차장 입구"
		, "S1_남애3리"=> "14:30|남애3리 입구"
		, "S1_인구"=> "14:35|현남보건지소 맞은편"
		, "S1_죽도"=> "14:40|GS25 죽도비치점 맞은편"
		, "S1_동산항"=> "14:45|동산항해변 입구"
		...
		, "E1_신도림"=> "07:00|홈플러스 신도림점 앞"
		, "E1_대림역"=> "07:10|대림역 2번출구 앞"
