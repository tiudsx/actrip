...
while ($row = mysqli_fetch_assoc($result_setlist)){
    ...
    ?>
            ...
            <tr name="btnTrList" style="text-align:center;cursor:pointer;" onclick="fnListView(this);">
                <td style="text-align: center;"><?=$PreMainNumber?></td>
                <td style="text-align: center;"><?=$res_date?></td>
                <td style="text-align: center;"><?=$user_name?></td>
                <td style="text-align: center;"><?if($ChangeChk > 0){ echo "승인필요"; }else{ echo ""; }?></td>
            ...
            <tr id="<?=$PreMainNumber?>" style="display:none;">
                <td colspan="5">
                    ...
                    <div class="write_table" style="padding-bottom:15px;text-align:center;">
                        <input type="button" class="gg_btn gg_btn_grid large gg_btn_color" style="width:90px; height:30px;" value="상태변경하기" onclick="fnConfirmUpdate(1, this);" />
                    </div>
                    <?}?>
                </td>
            </tr>
...
?>
            ...
            <tr name="btnTrList" style="text-align:center;cursor:pointer;" onclick="fnListView(this);">
                ...
                <td style="text-align: center;"><?=$res_date?></td>
                <td style="text-align: center;"><?=$user_name?></td>
                <td style="text-align: center;"><?if($ChangeChk > 0){ echo "승인필요"; }?></td>
                <td style="text-align: center;"><?if($etc != ""){ echo "있음"; }?></td>
            </tr>
            <tr id="<?=$PreMainNumber?>" style="display:none;">
                <td colspan="5">
