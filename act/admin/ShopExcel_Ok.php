...
foreach($data as $key => $row) {
    ...
    if($row[1] == "eat"){
        ...
        if($row[0] != "P"){
            ...
            $sub_tag = "";
            $sub_info = "서핑강습|0|".$row[16]."@숙박|게스트하우스|0|".$row[18];
            ...
            //상세설명 구분 : file / html
            $content_type = $row[24];
            $content = str_replace("act_content", "act_content/".$row[53],str_replace("'", "\"",$row[25]));
            $lesson_yn = $row[26];
            $rent_yn = $row[27];
            $bbq_yn = "N";
            $use_yn = "Y";
            ...
            ($seq, 1, '비수기1', '2020-04-01', '2020-06-30', '0,1,2,3,4,5,6', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 0, 0, 0, 0, 'N'), 
            ($seq, 2, '성수기1', '2020-07-01', '2020-08-31', '0,1,2,3,4,5,6', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 0, 0, 5000, 0, 'N'), 
            ($seq, 3, '비수기2', '2020-09-01', '2019-10-31', '0,1,2,3,4,5,6', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 0, 0, 0, 0, 'N');";
            $result_set = mysqli_query($conn, $select_query);
            ...
            ($seq, 'bbq', '바베큐파티', '', '', 20, 20, '', 25000, 25000, 25000, 0, 'N', 'Y', 'N', -1, 8);";
            $result_set = mysqli_query($conn, $select_query);
